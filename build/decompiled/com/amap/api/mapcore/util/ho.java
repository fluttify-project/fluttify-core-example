...
public class ho {
   ...
   public static byte[] a(int var0) {
      ...
      System.arraycopy(d, var0 * 4, var1, 0, 4);
      int var2 = (var1[0] & 255) * 256 + (var1[1] & 255);
      int var3 = (var1[2] & 255) * 256 + (var1[3] & 255);
      byte[] var4 = new byte[var3];
      System.arraycopy(d, var2, var4, 0, var3);
      return var4;
   }

   public static hf a() {
      try {
         hf var0 = (new hf$a("aiu", "1.0.0", "aiu")).a(new String[0]).a();
         return var0;
      } catch (gt var1) {
