...
public class MapView extends FrameLayout {
   ...
   public MapView(Context var1, AMapOptions var2) {
      super(var1);
      this.a(var1);
      this.getMapFragmentDelegate().setContext(var1);
   ...
   protected IMapFragmentDelegate getMapFragmentDelegate() {
      if (this.a == null) {
         try {
            this.a = (IMapFragmentDelegate)is.a().a(this.getContext(), fi.e(), "com.amap.api.wrapper.MapFragmentDelegateWrapper", z.class, new Class[]{Integer.TYPE}, new Object[]{Integer.valueOf(0)});
            if (this.a == null) {
               this.a = (IMapFragmentDelegate)ik.a(this.getContext(), fi.e(), "com.amap.api.wrapper.MapFragmentDelegateWrapper", z.class, new Class[]{Integer.TYPE}, new Object[]{Integer.valueOf(0)});
            }
