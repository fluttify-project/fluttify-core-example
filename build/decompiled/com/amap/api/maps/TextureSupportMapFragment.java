...
public class TextureSupportMapFragment extends Fragment {
   ...
   protected IMapFragmentDelegate getMapFragmentDelegate(Context var1) {
      if (this.b == null) {
         try {
            this.b = (IMapFragmentDelegate)is.a().a(var1, fi.e(), "com.amap.api.wrapper.MapFragmentDelegateWrapper", z.class, new Class[]{Integer.TYPE}, new Object[]{Integer.valueOf(1)});
            if (this.b == null) {
               this.b = (IMapFragmentDelegate)ik.a(var1, fi.e(), "com.amap.api.wrapper.MapFragmentDelegateWrapper", z.class, new Class[]{Integer.TYPE}, new Object[]{Integer.valueOf(1)});
            }
