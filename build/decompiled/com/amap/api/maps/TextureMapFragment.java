...
public class TextureMapFragment extends Fragment {
   ...
   public static TextureMapFragment newInstance(AMapOptions var0) {
      TextureMapFragment var1 = new TextureMapFragment();
   ...
   protected IMapFragmentDelegate getMapFragmentDelegate() {
      if (this.b == null) {
         try {
            this.b = (IMapFragmentDelegate)is.a().a(this.getActivity(), fi.e(), "com.amap.api.wrapper.MapFragmentDelegateWrapper", z.class, new Class[]{Integer.TYPE}, new Object[]{Integer.valueOf(1)});
            if (this.b == null) {
               this.b = (IMapFragmentDelegate)ik.a(this.getActivity(), fi.e(), "com.amap.api.wrapper.MapFragmentDelegateWrapper", z.class, new Class[]{Integer.TYPE}, new Object[]{Integer.valueOf(1)});
            }
