...
class com_amap_api_maps_model_particle_CurveSizeOverLife extends java_lang_Object  {
  ...
  Future<void> createNativeInstace() async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.model.particle.CurveSizeOverLife::createNativeInstace', {"refId": refId});
  ...
  Future<double> getSizeX(double var1) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.model.particle.CurveSizeOverLife::getSizeX', {"var1": var1, "refId": refId});
  ...
  Future<double> getSizeY(double var1) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.model.particle.CurveSizeOverLife::getSizeY', {"var1": var1, "refId": refId});
  ...
  Future<double> getSizeZ(double var1) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.model.particle.CurveSizeOverLife::getSizeZ', {"var1": var1, "refId": refId});
