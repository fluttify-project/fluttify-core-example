...
class com_amap_api_maps_AMapOptions extends java_lang_Object with android_os_Parcelable {
  ...
  Future<com_amap_api_maps_AMapOptions> logoPosition(int var1) async {
    ...
    if (result == null) {
      ...
      kNativeObjectPool.add(com_amap_api_maps_AMapOptions()..refId = result..tag = 'amap_base_flutter');
      return com_amap_api_maps_AMapOptions()..refId = result..tag = 'amap_base_flutter';
    }
  }
