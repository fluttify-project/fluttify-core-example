...
class com_amap_api_maps_model_GL3DModelOptions extends java_lang_Object  {
  ...
  Future<com_amap_api_maps_model_GL3DModelOptions> textureDrawable(com_amap_api_maps_model_BitmapDescriptor var1) async {
    ...
    if (result == null) {
      ...
      kNativeObjectPool.add(com_amap_api_maps_model_GL3DModelOptions()..refId = result..tag = 'amap_base_flutter');
      return com_amap_api_maps_model_GL3DModelOptions()..refId = result..tag = 'amap_base_flutter';
    }
  }
