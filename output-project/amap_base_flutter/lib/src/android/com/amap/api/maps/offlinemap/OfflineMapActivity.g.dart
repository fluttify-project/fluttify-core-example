...
class com_amap_api_maps_offlinemap_OfflineMapActivity extends com_amap_api_offlineservice_AMapPermissionActivity  {
  ...
  Future<void> showScr() async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.offlinemap.OfflineMapActivity::showScr', {"refId": refId});
  ...
  Future<void> closeScr() async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.offlinemap.OfflineMapActivity::closeScr', {"refId": refId});
  ...
  Future<void> onClick(android_view_View var1) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.offlinemap.OfflineMapActivity::onClick', {"var1": var1.refId, "refId": refId});
