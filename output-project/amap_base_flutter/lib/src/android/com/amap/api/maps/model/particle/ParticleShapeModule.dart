...
class com_amap_api_maps_model_particle_ParticleShapeModule extends Ref_Android {
  com_amap_api_maps_model_particle_ParticleShapeModule.withRefId(int refId): super(refId);
