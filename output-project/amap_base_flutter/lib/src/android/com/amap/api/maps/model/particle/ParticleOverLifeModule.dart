...
class com_amap_api_maps_model_particle_ParticleOverLifeModule extends Ref_Android {
  com_amap_api_maps_model_particle_ParticleOverLifeModule.withRefId(int refId): super(refId);
