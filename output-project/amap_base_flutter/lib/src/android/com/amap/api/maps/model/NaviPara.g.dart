...
class com_amap_api_maps_model_NaviPara extends java_lang_Object  {
  ...
  Future<void> setTargetPoint(com_amap_api_maps_model_LatLng var1) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.model.NaviPara::setTargetPoint', {"var1": var1.refId, "refId": refId});
  ...
  Future<void> setNaviStyle(int var1) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.model.NaviPara::setNaviStyle', {"var1": var1, "refId": refId});
  ...
  Future<com_amap_api_maps_model_LatLng> getTargetPoint() async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.model.NaviPara::getTargetPoint', {"refId": refId});
  ...
  Future<int> getNaviStyle() async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.model.NaviPara::getNaviStyle', {"refId": refId});
