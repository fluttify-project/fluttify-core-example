...
class com_amap_api_maps_model_MultiPointItem extends java_lang_Object  {
  ...
  Future<com_amap_api_maps_model_LatLng> getLatLng() async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.model.MultiPointItem::getLatLng', {"refId": refId});
  ...
  Future<void> setLatLng(com_amap_api_maps_model_LatLng var1) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.model.MultiPointItem::setLatLng', {"var1": var1.refId, "refId": refId});
  ...
  Future<String> getCustomerId() async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.model.MultiPointItem::getCustomerId', {"refId": refId});
  ...
  Future<void> setCustomerId(String var1) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.model.MultiPointItem::setCustomerId', {"var1": var1, "refId": refId});
  ...
  Future<String> getSnippet() async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.model.MultiPointItem::getSnippet', {"refId": refId});
  ...
  Future<void> setSnippet(String var1) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.model.MultiPointItem::setSnippet', {"var1": var1, "refId": refId});
  ...
  Future<String> getTitle() async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.model.MultiPointItem::getTitle', {"refId": refId});
  ...
  Future<void> setTitle(String var1) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.model.MultiPointItem::setTitle', {"var1": var1, "refId": refId});
  ...
  Future<com_autonavi_amap_mapcore_IPoint> getIPoint() async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.model.MultiPointItem::getIPoint', {"refId": refId});
  ...
  Future<void> setIPoint(com_autonavi_amap_mapcore_IPoint var1) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.model.MultiPointItem::setIPoint', {"var1": var1.refId, "refId": refId});
