...
class com_amap_api_maps_model_TileOverlayOptions extends java_lang_Object with android_os_Parcelable {
  ...
  Future<com_amap_api_maps_model_TileOverlayOptions> tileProvider(com_amap_api_maps_model_TileProvider var1) async {
    ...
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.model.TileOverlayOptions::tileProvider', {"refId": refId});
    ...
    if (result == null) {
      ...
      kNativeObjectPool.add(com_amap_api_maps_model_TileOverlayOptions()..refId = result..tag = 'amap_base_flutter');
      return com_amap_api_maps_model_TileOverlayOptions()..refId = result..tag = 'amap_base_flutter';
    }
  }
