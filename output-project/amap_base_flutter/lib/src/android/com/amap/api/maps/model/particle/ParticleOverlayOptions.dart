...
class com_amap_api_maps_model_particle_ParticleOverlayOptions extends Ref_Android {
  com_amap_api_maps_model_particle_ParticleOverlayOptions.withRefId(int refId): super(refId);
