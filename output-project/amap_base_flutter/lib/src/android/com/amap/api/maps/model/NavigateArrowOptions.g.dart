...
class com_amap_api_maps_model_NavigateArrowOptions extends java_lang_Object with android_os_Parcelable {
  ...
  Future<com_amap_api_maps_model_NavigateArrowOptions> add(com_amap_api_maps_model_LatLng var1) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.model.NavigateArrowOptions::add', {"var1": var1.refId, "refId": refId});
    ...
    if (result == null) {
      ...
      kNativeObjectPool.add(com_amap_api_maps_model_NavigateArrowOptions()..refId = result);
  ...
  Future<com_amap_api_maps_model_NavigateArrowOptions> addAll(List<com_amap_api_maps_model_LatLng> var1) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.model.NavigateArrowOptions::addAll', {"var1": var1.map((it) => it.refId).toList(), "refId": refId});
  ...
  Future<com_amap_api_maps_model_NavigateArrowOptions> width(double var1) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.model.NavigateArrowOptions::width', {"var1": var1, "refId": refId});
  ...
  Future<com_amap_api_maps_model_NavigateArrowOptions> topColor(int var1) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.model.NavigateArrowOptions::topColor', {"var1": var1, "refId": refId});
  ...
  Future<com_amap_api_maps_model_NavigateArrowOptions> sideColor(int var1) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.model.NavigateArrowOptions::sideColor', {"var1": var1, "refId": refId});
  ...
  Future<com_amap_api_maps_model_NavigateArrowOptions> zIndex(double var1) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.model.NavigateArrowOptions::zIndex', {"var1": var1, "refId": refId});
  ...
  Future<com_amap_api_maps_model_NavigateArrowOptions> visible(bool var1) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.model.NavigateArrowOptions::visible', {"var1": var1, "refId": refId});
  ...
  Future<com_amap_api_maps_model_NavigateArrowOptions> set3DModel(bool var1) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.model.NavigateArrowOptions::set3DModel', {"var1": var1, "refId": refId});
  ...
  Future<List<com_amap_api_maps_model_LatLng>> getPoints() async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.model.NavigateArrowOptions::getPoints', {"refId": refId});
  ...
  Future<double> getWidth() async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.model.NavigateArrowOptions::getWidth', {"refId": refId});
  ...
  Future<int> getTopColor() async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.model.NavigateArrowOptions::getTopColor', {"refId": refId});
  ...
  Future<int> getSideColor() async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.model.NavigateArrowOptions::getSideColor', {"refId": refId});
  ...
  Future<double> getZIndex() async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.model.NavigateArrowOptions::getZIndex', {"refId": refId});
  ...
  Future<bool> isVisible() async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.model.NavigateArrowOptions::isVisible', {"refId": refId});
  ...
  Future<bool> is3DModel() async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.model.NavigateArrowOptions::is3DModel', {"refId": refId});
  ...
  Future<void> setPoints(List<com_amap_api_maps_model_LatLng> var1) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.model.NavigateArrowOptions::setPoints', {"var1": var1.map((it) => it.refId).toList(), "refId": refId});
