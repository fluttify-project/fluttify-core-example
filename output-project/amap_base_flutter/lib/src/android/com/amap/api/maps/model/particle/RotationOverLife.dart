...
class com_amap_api_maps_model_particle_RotationOverLife extends Ref_Android {
  com_amap_api_maps_model_particle_RotationOverLife.withRefId(int refId): super(refId);
