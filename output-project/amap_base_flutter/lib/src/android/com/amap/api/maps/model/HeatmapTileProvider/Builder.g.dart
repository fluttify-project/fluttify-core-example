...
class com_amap_api_maps_model_HeatmapTileProvider_Builder extends java_lang_Object  {
  ...
  Future<com_amap_api_maps_model_HeatmapTileProvider> build() async {
    ...
    if (result == null) {
      ...
      kNativeObjectPool.add(com_amap_api_maps_model_HeatmapTileProvider()..refId = result..tag = 'amap_base_flutter');
      return com_amap_api_maps_model_HeatmapTileProvider()..refId = result..tag = 'amap_base_flutter';
    }
  }
