...
class com_amap_api_maps_model_particle_ParticleShapeModule extends com_autonavi_amap_mapcore_AbstractNativeInstance  {
  ...
  Future<bool> isUseRatio() async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.model.particle.ParticleShapeModule::isUseRatio', {"refId": refId});
  ...
  Future<List<double>> getPoint() async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.model.particle.ParticleShapeModule::getPoint', {"refId": refId});
