...
class com_amap_api_maps_model_particle_ConstantRotationOverLife extends java_lang_Object  {
  ...
  Future<void> createNativeInstace() async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.model.particle.ConstantRotationOverLife::createNativeInstace', {"refId": refId});
  ...
  Future<double> getRotate() async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.model.particle.ConstantRotationOverLife::getRotate', {"refId": refId});
