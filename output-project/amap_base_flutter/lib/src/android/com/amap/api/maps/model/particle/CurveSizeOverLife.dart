...
class com_amap_api_maps_model_particle_CurveSizeOverLife extends Ref_Android {
  com_amap_api_maps_model_particle_CurveSizeOverLife.withRefId(int refId): super.withRefId(refId);
