...
class com_amap_api_maps_model_BitmapDescriptor extends java_lang_Object with android_os_Parcelable {
  ...
  Future<String> getId() async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.model.BitmapDescriptor::getId', {"refId": refId});
  ...
  Future<com_amap_api_maps_model_BitmapDescriptor> clone() async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.model.BitmapDescriptor::clone', {"refId": refId});
  ...
  Future<android_graphics_Bitmap> getBitmap() async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.model.BitmapDescriptor::getBitmap', {"refId": refId});
  ...
  Future<int> getWidth() async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.model.BitmapDescriptor::getWidth', {"refId": refId});
  ...
  Future<int> getHeight() async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.model.BitmapDescriptor::getHeight', {"refId": refId});
