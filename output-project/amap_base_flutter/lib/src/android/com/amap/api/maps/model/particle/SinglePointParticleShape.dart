...
class com_amap_api_maps_model_particle_SinglePointParticleShape extends Ref_Android {
  com_amap_api_maps_model_particle_SinglePointParticleShape.withRefId(int refId): super.withRefId(refId);
