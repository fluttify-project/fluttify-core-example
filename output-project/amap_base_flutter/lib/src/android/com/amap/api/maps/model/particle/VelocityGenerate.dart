...
class com_amap_api_maps_model_particle_VelocityGenerate extends Ref_Android {
  com_amap_api_maps_model_particle_VelocityGenerate.withRefId(int refId): super(refId);
