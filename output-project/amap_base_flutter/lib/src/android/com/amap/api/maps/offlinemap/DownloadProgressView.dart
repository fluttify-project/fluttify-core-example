...
class com_amap_api_maps_offlinemap_DownloadProgressView extends Ref_Android {
  com_amap_api_maps_offlinemap_DownloadProgressView.withRefId(int refId): super.withRefId(refId);
