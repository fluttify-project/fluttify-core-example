...
class com_amap_api_maps_CameraUpdateFactory extends java_lang_Object  {
  ...
  static Future<com_amap_api_maps_CameraUpdate> zoomIn() async {
    ...
    if (result == null) {
      ...
      kNativeObjectPool.add(com_amap_api_maps_CameraUpdate()..refId = result..tag = 'amap_base_flutter');
      return com_amap_api_maps_CameraUpdate()..refId = result..tag = 'amap_base_flutter';
    }
  }
