...
//  }
  ...
  Future<com_amap_api_maps_CoordinateConverter> coord(
      com_amap_api_maps_model_LatLng var1) async {
    // 日志打印
    print(
        'fluttify-dart: com.amap.api.maps.CoordinateConverter@$refId::coord([])');

    // 调用原生方法
    final result = await _channel.invokeMethod(
        'com.amap.api.maps.CoordinateConverter::coord',
  ...
  Future<com_amap_api_maps_model_LatLng> convert() async {
    // 日志打印
    print(
        'fluttify-dart: com.amap.api.maps.CoordinateConverter@$refId::convert([])');

    // 调用原生方法
    final result = await _channel.invokeMethod(
        'com.amap.api.maps.CoordinateConverter::convert', {"refId": refId});
  ...
  static Future<bool> isAMapDataAvailable(double var0, double var2) async {
    // 日志打印
    print(
        'fluttify-dart: com.amap.api.maps.CoordinateConverter::isAMapDataAvailable([\'var0\':$var0, \'var2\':$var2])');

    // 调用原生方法
    final result = await _channel.invokeMethod(
        'com.amap.api.maps.CoordinateConverter::isAMapDataAvailable',
        {"var0": var0, "var2": var2});
