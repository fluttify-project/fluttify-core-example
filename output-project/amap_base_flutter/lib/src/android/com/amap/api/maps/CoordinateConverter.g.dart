...
class com_amap_api_maps_CoordinateConverter extends java_lang_Object  {
  ...
  Future<com_amap_api_maps_CoordinateConverter> from(com_amap_api_maps_CoordinateConverter_CoordType var1) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.CoordinateConverter::from', {"var1": var1.index, "refId": refId});
    ...
    if (result == null) {
      ...
      kNativeObjectPool.add(com_amap_api_maps_CoordinateConverter()..refId = result);
  ...
  Future<com_amap_api_maps_CoordinateConverter> coord(com_amap_api_maps_model_LatLng var1) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.CoordinateConverter::coord', {"var1": var1.refId, "refId": refId});
  ...
  Future<com_amap_api_maps_model_LatLng> convert() async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.CoordinateConverter::convert', {"refId": refId});
  ...
  static Future<bool> isAMapDataAvailable(double var0, double var2) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.CoordinateConverter::isAMapDataAvailable', {"var0": var0, "var2": var2});
