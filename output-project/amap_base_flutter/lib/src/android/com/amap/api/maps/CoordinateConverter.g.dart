...
class com_amap_api_maps_CoordinateConverter extends java_lang_Object  {
  ...
  Future<com_amap_api_maps_CoordinateConverter> from(com_amap_api_maps_CoordinateConverter_CoordType var1) async {
    ...
    if (result == null) {
      ...
      kNativeObjectPool.add(com_amap_api_maps_CoordinateConverter()..refId = result..tag = 'amap_base_flutter');
      return com_amap_api_maps_CoordinateConverter()..refId = result..tag = 'amap_base_flutter';
    }
  }
