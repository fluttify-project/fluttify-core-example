...
class com_amap_api_maps_model_PoiPara extends java_lang_Object  {
  ...
  Future<com_amap_api_maps_model_LatLng> getCenter() async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.model.PoiPara::getCenter', {"refId": refId});
  ...
  Future<void> setCenter(com_amap_api_maps_model_LatLng var1) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.model.PoiPara::setCenter', {"var1": var1.refId, "refId": refId});
  ...
  Future<String> getKeywords() async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.model.PoiPara::getKeywords', {"refId": refId});
  ...
  Future<void> setKeywords(String var1) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.model.PoiPara::setKeywords', {"var1": var1, "refId": refId});
