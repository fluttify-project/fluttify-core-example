...
class com_amap_api_maps_model_ArcOptions extends Ref_Android {
  com_amap_api_maps_model_ArcOptions.withRefId(int refId): super.withRefId(refId);
  ...
  // 生成方法们
   Future<com_amap_api_maps_model_ArcOptions> point(com_amap_api_maps_model_LatLng var1, com_amap_api_maps_model_LatLng var2, com_amap_api_maps_model_LatLng var3) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.maps.model.ArcOptions::point', {"var1": var1.refId, "var2": var2.refId, "var3": var3.refId, "refId": refId});
   ...
   Future<com_amap_api_maps_model_ArcOptions> strokeWidth(double var1) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.maps.model.ArcOptions::strokeWidth', {"var1": var1, "refId": refId});
   ...
   Future<com_amap_api_maps_model_ArcOptions> strokeColor(int var1) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.maps.model.ArcOptions::strokeColor', {"var1": var1, "refId": refId});
   ...
   Future<com_amap_api_maps_model_ArcOptions> zIndex(double var1) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.maps.model.ArcOptions::zIndex', {"var1": var1, "refId": refId});
   ...
   Future<com_amap_api_maps_model_ArcOptions> visible(bool var1) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.maps.model.ArcOptions::visible', {"var1": var1, "refId": refId});
   ...
   Future<double> getStrokeWidth() async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.maps.model.ArcOptions::getStrokeWidth', {"refId": refId});
   ...
   Future<int> getStrokeColor() async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.maps.model.ArcOptions::getStrokeColor', {"refId": refId});
   ...
   Future<double> getZIndex() async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.maps.model.ArcOptions::getZIndex', {"refId": refId});
   ...
   Future<bool> isVisible() async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.maps.model.ArcOptions::isVisible', {"refId": refId});
   ...
   Future<com_amap_api_maps_model_LatLng> getStart() async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.maps.model.ArcOptions::getStart', {"refId": refId});
   ...
   Future<com_amap_api_maps_model_LatLng> getPassed() async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.maps.model.ArcOptions::getPassed', {"refId": refId});
   ...
   Future<com_amap_api_maps_model_LatLng> getEnd() async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.maps.model.ArcOptions::getEnd', {"refId": refId});
