...
class com_amap_api_maps_model_HeatmapTileProvider extends java_lang_Object  {
  ...
  Future<com_amap_api_maps_model_Tile> getTile(int var1, int var2, int var3) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.model.HeatmapTileProvider::getTile', {"var1": var1, "var2": var2, "var3": var3, "refId": refId});
  ...
  Future<int> getTileHeight() async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.model.HeatmapTileProvider::getTileHeight', {"refId": refId});
  ...
  Future<int> getTileWidth() async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.model.HeatmapTileProvider::getTileWidth', {"refId": refId});
