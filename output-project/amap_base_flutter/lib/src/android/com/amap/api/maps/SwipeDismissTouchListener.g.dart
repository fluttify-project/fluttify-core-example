...
class com_amap_api_maps_SwipeDismissTouchListener extends java_lang_Object  {
  ...
  Future<bool> onTouch(android_view_View var1, android_view_MotionEvent var2) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.amap.api.maps.SwipeDismissTouchListener::onTouch', {"var1": var1.refId, "var2": var2.refId, "refId": refId});
