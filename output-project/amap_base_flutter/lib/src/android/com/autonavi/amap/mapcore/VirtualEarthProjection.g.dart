...
class com_autonavi_amap_mapcore_VirtualEarthProjection extends java_lang_Object  {
  ...
  static Future<double> clip(double var0, double var2, double var4) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.autonavi.amap.mapcore.VirtualEarthProjection::clip', {"var0": var0, "var2": var2, "var4": var4});
  ...
  static Future<android_graphics_Point> latLongToPixels(int var0, int var1, int var2) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.autonavi.amap.mapcore.VirtualEarthProjection::latLongToPixels', {"var0": var0, "var1": var1, "var2": var2});
  ...
  static Future<com_autonavi_amap_mapcore_DPoint> pixelsToLatLong(int var0, int var2, int var4) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.autonavi.amap.mapcore.VirtualEarthProjection::pixelsToLatLong', {"var0": var0, "var2": var2, "var4": var4});
