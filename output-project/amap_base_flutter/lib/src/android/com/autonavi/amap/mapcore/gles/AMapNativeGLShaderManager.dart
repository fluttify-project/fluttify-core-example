...
class com_autonavi_amap_mapcore_gles_AMapNativeGLShaderManager extends Ref_Android {
  com_autonavi_amap_mapcore_gles_AMapNativeGLShaderManager.withRefId(int refId): super.withRefId(refId);
