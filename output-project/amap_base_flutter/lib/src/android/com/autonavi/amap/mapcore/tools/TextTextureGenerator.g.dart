...
class com_autonavi_amap_mapcore_tools_TextTextureGenerator extends java_lang_Object  {
  ...
  static Future<int> getNearstSize2N(int var0) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.autonavi.amap.mapcore.tools.TextTextureGenerator::getNearstSize2N', {"var0": var0});
  ...
  Future<List<int>> getTextPixelBuffer(int var1, int var2) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.autonavi.amap.mapcore.tools.TextTextureGenerator::getTextPixelBuffer', {"var1": var1, "var2": var2, "refId": refId});
  ...
  Future<List<int>> getCharsWidths(List<int> var1) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.autonavi.amap.mapcore.tools.TextTextureGenerator::getCharsWidths', {"var1": var1, "refId": refId});
