...
class com_autonavi_amap_mapcore_tools_GLConvertUtil {
  com_autonavi_amap_mapcore_tools_GLConvertUtil.withRefId(this.refId);
  ...
  static Future<String> writeInt(List<int> var0, int var1, int var2) async {
    // 日志打印
  ...
  static Future<String> moveArray(List<int> var0, List<int> var2, int var1, int var3, int var4) async {
    // 日志打印
