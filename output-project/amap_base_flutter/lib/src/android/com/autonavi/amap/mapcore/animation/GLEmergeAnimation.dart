...
class com_autonavi_amap_mapcore_animation_GLEmergeAnimation extends Ref_Android {
  com_autonavi_amap_mapcore_animation_GLEmergeAnimation.withRefId(int refId): super.withRefId(refId);
  ...
  Future<void> set_mStartPoint(com_amap_api_maps_model_LatLng mStartPoint) async {
    await _channel.invokeMethod('com.autonavi.amap.mapcore.animation.GLEmergeAnimation::set_mStartPoint', {'refId': refId, "mStartPoint": mStartPoint});
  }
