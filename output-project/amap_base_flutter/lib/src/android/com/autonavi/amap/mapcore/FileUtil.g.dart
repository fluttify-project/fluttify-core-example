...
class com_autonavi_amap_mapcore_FileUtil extends java_lang_Object  {
  ...
  static Future<String> getMapBaseStorage(android_content_Context var0) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.autonavi.amap.mapcore.FileUtil::getMapBaseStorage', {"var0": var0.refId});
  ...
  static Future<String> getExternalStroragePath(android_content_Context var0) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.autonavi.amap.mapcore.FileUtil::getExternalStroragePath', {"var0": var0.refId});
  ...
  static Future<void> writeDatasToFile(String var0, List<int> var1) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.autonavi.amap.mapcore.FileUtil::writeDatasToFile', {"var0": var0, "var1": var1});
  ...
  static Future<List<int>> readFileContents(String var0) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.autonavi.amap.mapcore.FileUtil::readFileContents', {"var0": var0});
  ...
  static Future<void> createNoMediaFileIfNotExist(String var0) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.autonavi.amap.mapcore.FileUtil::createNoMediaFileIfNotExist', {"var0": var0});
  ...
  static Future<void> saveFile(String var0, String var1, bool var2) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.autonavi.amap.mapcore.FileUtil::saveFile', {"var0": var0, "var1": var1, "var2": var2});
  ...
  static Future<List<int>> readFileContentsFromAssets(android_content_Context var0, String var1) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.autonavi.amap.mapcore.FileUtil::readFileContentsFromAssets', {"var0": var0.refId, "var1": var1});
  ...
  static Future<String> getName(String var0) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.autonavi.amap.mapcore.FileUtil::getName', {"var0": var0});
  ...
  static Future<int> indexOfLastSeparator(String var0) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.autonavi.amap.mapcore.FileUtil::indexOfLastSeparator', {"var0": var0});
