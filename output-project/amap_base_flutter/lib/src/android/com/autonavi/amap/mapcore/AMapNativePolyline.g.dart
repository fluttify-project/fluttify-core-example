...
class com_autonavi_amap_mapcore_AMapNativePolyline extends java_lang_Object  {
  ...
  static Future<int> nativeCreate() async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.autonavi.amap.mapcore.AMapNativePolyline::nativeCreate', );
  ...
  static Future<void> nativeSetGLShaderManager(int var0, int var2) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.autonavi.amap.mapcore.AMapNativePolyline::nativeSetGLShaderManager', {"var0": var0, "var2": var2});
  ...
  static Future<int> nativeDestroy(int var0) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.autonavi.amap.mapcore.AMapNativePolyline::nativeDestroy', {"var0": var0});
