...
mixin com_autonavi_amap_mapcore_interfaces_IMultiPointOverlay on Object {
  ...
  Future<String> draw(com_autonavi_amap_mapcore_MapConfig var1, List<double> var2, List<double> var3) {}
