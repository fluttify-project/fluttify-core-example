...
class com_autonavi_amap_mapcore_animation_GLTransformation extends Ref_Android {
  com_autonavi_amap_mapcore_animation_GLTransformation.withRefId(int refId): super.withRefId(refId);
