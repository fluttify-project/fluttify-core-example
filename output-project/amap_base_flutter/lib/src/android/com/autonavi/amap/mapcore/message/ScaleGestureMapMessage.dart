...
class com_autonavi_amap_mapcore_message_ScaleGestureMapMessage extends Ref_Android {
  com_autonavi_amap_mapcore_message_ScaleGestureMapMessage.withRefId(int refId): super.withRefId(refId);
  ...
  // 生成方法们
  static Future<com_autonavi_amap_mapcore_message_ScaleGestureMapMessage> obtain(double var1, int var0, int var2, int var3) async {
    // 日志打印
