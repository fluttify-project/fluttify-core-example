...
class com_autonavi_amap_mapcore_message_AbstractGestureMapMessage extends Ref_Android {
  com_autonavi_amap_mapcore_message_AbstractGestureMapMessage.withRefId(int refId): super(refId);
