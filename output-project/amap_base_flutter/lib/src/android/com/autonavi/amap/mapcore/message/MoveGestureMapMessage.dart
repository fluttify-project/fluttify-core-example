...
class com_autonavi_amap_mapcore_message_MoveGestureMapMessage extends Ref_Android {
  com_autonavi_amap_mapcore_message_MoveGestureMapMessage.withRefId(int refId): super.withRefId(refId);
