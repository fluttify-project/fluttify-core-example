...
class com_autonavi_amap_mapcore_Inner_3dMap_locationOption extends java_lang_Object  {
  ...
  Future<com_autonavi_amap_mapcore_Inner_3dMap_locationOption> setInterval(int var1) async {
    ...
    if (result == null) {
      ...
      kNativeObjectPool.add(com_autonavi_amap_mapcore_Inner_3dMap_locationOption()..refId = result..tag = 'amap_base_flutter');
      return com_autonavi_amap_mapcore_Inner_3dMap_locationOption()..refId = result..tag = 'amap_base_flutter';
    }
  }
