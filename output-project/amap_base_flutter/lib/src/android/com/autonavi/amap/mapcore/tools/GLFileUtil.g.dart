...
class com_autonavi_amap_mapcore_tools_GLFileUtil extends java_lang_Object  {
  ...
  static Future<void> writeDatasToFile(String var0, List<int> var1) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.autonavi.amap.mapcore.tools.GLFileUtil::writeDatasToFile', {"var0": var0, "var1": var1});
  ...
  static Future<List<int>> readFileContents(String var0) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.autonavi.amap.mapcore.tools.GLFileUtil::readFileContents', {"var0": var0});
