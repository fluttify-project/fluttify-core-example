...
class com_autonavi_amap_mapcore_maploader_AMapLoader_ADataRequestParam {
  com_autonavi_amap_mapcore_maploader_AMapLoader_ADataRequestParam.withRefId(this.refId);
