...
class com_autonavi_ae_gmap_gloverlay_GLCrossVector_AVectorCrossAttr extends Ref_Android {
  com_autonavi_ae_gmap_gloverlay_GLCrossVector_AVectorCrossAttr.withRefId(int refId): super.withRefId(refId);
