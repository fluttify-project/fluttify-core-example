...
class com_autonavi_ae_gmap_glanimation_AbstractAdglAnimationParam2V extends Ref_Android {
  com_autonavi_ae_gmap_glanimation_AbstractAdglAnimationParam2V.withRefId(int refId): super.withRefId(refId);
