...
class com_autonavi_ae_gmap_gloverlay_GLCrossVector extends java_lang_Object  {
  ...
  Future<int> addVectorItem(com_autonavi_ae_gmap_gloverlay_GLCrossVector_AVectorCrossAttr var1, List<int> var2, int var3) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.autonavi.ae.gmap.gloverlay.GLCrossVector::addVectorItem', {"var1": var1.refId, "var2": var2, "var3": var3, "refId": refId});
  ...
  Future<void> addVectorRemainDis(int var1) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.autonavi.ae.gmap.gloverlay.GLCrossVector::addVectorRemainDis', {"var1": var1, "refId": refId});
  ...
  Future<void> addVectorCar(int var1, int var2, int var3) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.autonavi.ae.gmap.gloverlay.GLCrossVector::addVectorCar', {"var1": var1, "var2": var2, "var3": var3, "refId": refId});
  ...
  Future<void> setRoadResId(bool var1, int var2) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.autonavi.ae.gmap.gloverlay.GLCrossVector::setRoadResId', {"var1": var1, "var2": var2, "refId": refId});
  ...
  Future<void> setArrowResId(bool var1, int var2) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.autonavi.ae.gmap.gloverlay.GLCrossVector::setArrowResId', {"var1": var1, "var2": var2, "refId": refId});
  ...
  Future<void> setCarResId(int var1) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.autonavi.ae.gmap.gloverlay.GLCrossVector::setCarResId', {"var1": var1, "refId": refId});
  ...
  Future<void> setBackgroundResId(int var1) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.autonavi.ae.gmap.gloverlay.GLCrossVector::setBackgroundResId', {"var1": var1, "refId": refId});
  ...
  Future<void> setSkyResId(bool var1, int var2) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.autonavi.ae.gmap.gloverlay.GLCrossVector::setSkyResId', {"var1": var1, "var2": var2, "refId": refId});
  ...
  Future<int> getFBOTextureId() async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.autonavi.ae.gmap.gloverlay.GLCrossVector::getFBOTextureId', {"refId": refId});
  ...
  Future<void> initFBOTexture(int var1, int var2) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('com.autonavi.ae.gmap.gloverlay.GLCrossVector::initFBOTexture', {"var1": var1, "var2": var2, "refId": refId});
