...
class com_autonavi_ae_gmap_GLMapEngine_MapViewInitParam extends Ref_Android {
  com_autonavi_ae_gmap_GLMapEngine_MapViewInitParam.withRefId(int refId): super.withRefId(refId);
