...
class com_autonavi_ae_gmap_glanimation_AdglMapAnimGroup extends Ref_Android {
  com_autonavi_ae_gmap_glanimation_AdglMapAnimGroup.withRefId(int refId): super.withRefId(refId);
