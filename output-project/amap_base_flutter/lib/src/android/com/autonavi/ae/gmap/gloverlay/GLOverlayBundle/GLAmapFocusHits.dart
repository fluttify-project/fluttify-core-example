...
class com_autonavi_ae_gmap_gloverlay_GLOverlayBundle_GLAmapFocusHits {
  com_autonavi_ae_gmap_gloverlay_GLOverlayBundle_GLAmapFocusHits.withRefId(this.refId);
