...
class com_autonavi_ae_gmap_glanimation_AbstractAdglAnimationParam1V extends Ref_Android {
  com_autonavi_ae_gmap_glanimation_AbstractAdglAnimationParam1V.withRefId(int refId): super.withRefId(refId);
