...
class com_autonavi_ae_gmap_glanimation_AbstractAdglAnimationParam extends Ref_Android {
  com_autonavi_ae_gmap_glanimation_AbstractAdglAnimationParam.withRefId(int refId): super.withRefId(refId);
