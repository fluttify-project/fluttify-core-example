...
class com_autonavi_ae_gmap_GLMapEngine_InitParam extends Ref_Android {
  com_autonavi_ae_gmap_GLMapEngine_InitParam.withRefId(int refId): super.withRefId(refId);
