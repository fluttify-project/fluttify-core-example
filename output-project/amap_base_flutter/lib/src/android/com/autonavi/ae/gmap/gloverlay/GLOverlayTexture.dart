...
class com_autonavi_ae_gmap_gloverlay_GLOverlayTexture extends Ref_Android {
  com_autonavi_ae_gmap_gloverlay_GLOverlayTexture.withRefId(int refId): super.withRefId(refId);
