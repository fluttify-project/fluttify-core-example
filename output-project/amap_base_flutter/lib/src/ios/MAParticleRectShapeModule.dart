...
class MAParticleRectShapeModule extends NSObject with MAParticleShapeModule {
  MAParticleRectShapeModule.withRefId(int refId) : super.withRefId(refId);
  ...
  // 生成方法们
   Future<MAParticleRectShapeModule> initWithLeft(double left, double top, double right, double bottom, bool isUseRatio) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('MAParticleRectShapeModule::initWithLeft', {"left": left, "top": top, "right": right, "bottom": bottom, "isUseRatio": isUseRatio, "refId": refId});
