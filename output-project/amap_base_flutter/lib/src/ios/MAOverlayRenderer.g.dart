...
class MAOverlayRenderer extends NSObject  {
  ...
  Future<MAOverlay> get_overlay() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod("MAOverlayRenderer::get_overlay", {'refId': refId});
    kNativeObjectPool.add(MAGroundOverlay()..refId = result);
    return MAGroundOverlay()..refId = result;
  }
  
  Future<CGPoint> get_glPoints() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod("MAOverlayRenderer::get_glPoints", {'refId': refId});
    kNativeObjectPool.add(CGPoint()..refId = result);
    return CGPoint()..refId = result;
  }
  
  Future<int> get_glPointCount() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod("MAOverlayRenderer::get_glPointCount", {'refId': refId});
  
    return result;
  }
  
  Future<double> get_alpha() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod("MAOverlayRenderer::get_alpha", {'refId': refId});
  
    return result;
  }
  
  Future<double> get_contentScale() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod("MAOverlayRenderer::get_contentScale", {'refId': refId});
  ...
  Future<void> set_glPoints(List<CGPoint> glPoints) async {
    await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('MAOverlayRenderer::set_glPoints', {'refId': refId, "glPoints": glPoints.map((it) => it.refId).toList()});
  
  
  }
  
  Future<void> set_glPointCount(int glPointCount) async {
    await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('MAOverlayRenderer::set_glPointCount', {'refId': refId, "glPointCount": glPointCount});
  
  
  }
  
  Future<void> set_alpha(double alpha) async {
    await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('MAOverlayRenderer::set_alpha', {'refId': refId, "alpha": alpha});
