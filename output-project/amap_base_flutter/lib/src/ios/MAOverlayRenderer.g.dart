...
class MAOverlayRenderer extends NSObject  {
  ...
  Future<UIImage> get_strokeImage() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter').invokeMethod("MAOverlayRenderer::get_strokeImage", {'refId': refId});
  ...
  Future<void> set_strokeImage(UIImage strokeImage) async {
    await MethodChannel('me.yohom/amap_base_flutter').invokeMethod('MAOverlayRenderer::set_strokeImage', {'refId': refId, "strokeImage": strokeImage.refId});
