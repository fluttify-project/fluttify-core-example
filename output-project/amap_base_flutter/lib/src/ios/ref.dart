...
class Ref_iOS {
  ...
  Future<bool> isKindOfAMapURLSearch() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfAMapURLSearch', {'refId': refId});
    return result;
  }

  Future<bool> isKindOfAMapNaviConfig() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfAMapNaviConfig', {'refId': refId});
    return result;
  }

  Future<bool> isKindOfAMapRouteConfig() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfAMapRouteConfig', {'refId': refId});
    return result;
  }

  Future<bool> isKindOfAMapPOIConfig() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfAMapPOIConfig', {'refId': refId});
    return result;
  }

  Future<bool> isKindOfAMapServices() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfAMapServices', {'refId': refId});
    return result;
  }

  Future<bool> isKindOfMAOfflineCity() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfMAOfflineCity', {'refId': refId});
    return result;
  }
  ...
  Future<bool> isKindOfMAOfflineItemNationWide() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod(
            'RefClass::isKindOfMAOfflineItemNationWide', {'refId': refId});
    return result;
  }

  Future<bool> isKindOfMAMultiPoint() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfMAMultiPoint', {'refId': refId});
    return result;
  }

  Future<bool> isKindOfMAGroundOverlay() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfMAGroundOverlay', {'refId': refId});
    return result;
  }

  Future<bool> isKindOfMAPolygonRenderer() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfMAPolygonRenderer', {'refId': refId});
    return result;
  }
  ...
  Future<bool> isKindOfMAPinAnnotationView() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod(
            'RefClass::isKindOfMAPinAnnotationView', {'refId': refId});
    return result;
  }

  Future<bool> isKindOfMAHeatMapNode() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfMAHeatMapNode', {'refId': refId});
    return result;
  }

  Future<bool> isKindOfMAHeatMapGradient() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfMAHeatMapGradient', {'refId': refId});
    return result;
  }
  ...
  Future<bool> isKindOfMAHeatMapTileOverlay() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod(
            'RefClass::isKindOfMAHeatMapTileOverlay', {'refId': refId});
    return result;
  }

  Future<bool> isKindOfMAMapStatus() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfMAMapStatus', {'refId': refId});
    return result;
  }

  Future<bool> isKindOfMAPointAnnotation() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfMAPointAnnotation', {'refId': refId});
    return result;
  }

  Future<bool> isKindOfMACircle() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfMACircle', {'refId': refId});
    return result;
  }

  Future<bool> isKindOfMAArcRenderer() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfMAArcRenderer', {'refId': refId});
    return result;
  }
  ...
  Future<bool> isKindOfMAMapCustomStyleOptions() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod(
            'RefClass::isKindOfMAMapCustomStyleOptions', {'refId': refId});
    return result;
  }

  Future<bool> isKindOfMAPolygon() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfMAPolygon', {'refId': refId});
    return result;
  }

  Future<bool> isKindOfMAParticleOverlay() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfMAParticleOverlay', {'refId': refId});
    return result;
  }

  Future<bool> isKindOfMAPolyline() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfMAPolyline', {'refId': refId});
    return result;
  }

  Future<bool> isKindOfMAMultiColoredPolylineRenderer() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfMAMultiColoredPolylineRenderer',
            {'refId': refId});
    return result;
  }
  ...
  Future<bool> isKindOfMAAnimatedAnnotation() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod(
            'RefClass::isKindOfMAAnimatedAnnotation', {'refId': refId});
    return result;
  }

  Future<bool> isKindOfMAMultiTexturePolylineRenderer() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfMAMultiTexturePolylineRenderer',
            {'refId': refId});
    return result;
  }
  ...
  Future<bool> isKindOfMAOfflineProvince() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfMAOfflineProvince', {'refId': refId});
    return result;
  }
  ...
  Future<bool> isKindOfMATileOverlayRenderer() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod(
            'RefClass::isKindOfMATileOverlayRenderer', {'refId': refId});
    return result;
  }

  Future<bool> isKindOfMAOfflineItem() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfMAOfflineItem', {'refId': refId});
    return result;
  }

  Future<bool> isKindOfMAGeodesicPolyline() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfMAGeodesicPolyline', {'refId': refId});
    return result;
  }

  Future<bool> isKindOfMATouchPoi() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfMATouchPoi', {'refId': refId});
    return result;
  }
  ...
  Future<bool> isKindOfMAOfflineItemMunicipality() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod(
            'RefClass::isKindOfMAOfflineItemMunicipality', {'refId': refId});
    return result;
  }

  Future<bool> isKindOfMAMultiPolyline() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfMAMultiPolyline', {'refId': refId});
    return result;
  }

  Future<bool> isKindOfMATraceManager() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfMATraceManager', {'refId': refId});
    return result;
  }
  ...
  Future<bool> isKindOfMAMultiPointOverlayRenderer() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod(
            'RefClass::isKindOfMAMultiPointOverlayRenderer', {'refId': refId});
    return result;
  }

  Future<bool> isKindOfMAIndoorFloorInfo() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfMAIndoorFloorInfo', {'refId': refId});
    return result;
  }

  Future<bool> isKindOfMAIndoorInfo() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfMAIndoorInfo', {'refId': refId});
    return result;
  }

  Future<bool> isKindOfMAPolylineRenderer() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfMAPolylineRenderer', {'refId': refId});
    return result;
  }
  ...
  Future<bool> isKindOfMAAnnotationMoveAnimation() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod(
            'RefClass::isKindOfMAAnnotationMoveAnimation', {'refId': refId});
    return result;
  }

  Future<bool> isKindOfMAShape() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfMAShape', {'refId': refId});
    return result;
  }

  Future<bool> isKindOfMAAnnotationView() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfMAAnnotationView', {'refId': refId});
    return result;
  }

  Future<bool> isKindOfMATileOverlay() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfMATileOverlay', {'refId': refId});
    return result;
  }

  Future<bool> isKindOfMATileOverlayPath() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfMATileOverlayPath', {'refId': refId});
    return result;
  }
  ...
  Future<bool> isKindOfMACustomCalloutView() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod(
            'RefClass::isKindOfMACustomCalloutView', {'refId': refId});
    return result;
  }
  ...
  Future<bool> isKindOfMAOfflineItemCommonCity() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod(
            'RefClass::isKindOfMAOfflineItemCommonCity', {'refId': refId});
    return result;
  }

  Future<bool> isKindOfMAOfflineMap() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfMAOfflineMap', {'refId': refId});
    return result;
  }

  Future<bool> isKindOfMACircleRenderer() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfMACircleRenderer', {'refId': refId});
    return result;
  }
  ...
  Future<bool> isKindOfMAParticleOverlayRenderer() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod(
            'RefClass::isKindOfMAParticleOverlayRenderer', {'refId': refId});
    return result;
  }

  Future<bool> isKindOfMACoordinateBounds() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfMACoordinateBounds', {'refId': refId});
    return result;
  }

  Future<bool> isKindOfMACoordinateSpan() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfMACoordinateSpan', {'refId': refId});
    return result;
  }

  Future<bool> isKindOfMACoordinateRegion() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfMACoordinateRegion', {'refId': refId});
    return result;
  }

  Future<bool> isKindOfMAMapPoint() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfMAMapPoint', {'refId': refId});
    return result;
  }

  Future<bool> isKindOfMAMapSize() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfMAMapSize', {'refId': refId});
    return result;
  }

  Future<bool> isKindOfMAMapRect() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfMAMapRect', {'refId': refId});
    return result;
  }

  Future<bool> isKindOfMAParticleRandomVelocityGenerate() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfMAParticleRandomVelocityGenerate',
            {'refId': refId});
    return result;
  }
  ...
  Future<bool> isKindOfMAParticleRandomColorGenerate() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfMAParticleRandomColorGenerate',
            {'refId': refId});
    return result;
  }
  ...
  Future<bool> isKindOfMAParticleConstantRotationGenerate() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfMAParticleConstantRotationGenerate',
            {'refId': refId});
    return result;
  }
  ...
  Future<bool> isKindOfMAParticleCurveSizeGenerate() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod(
            'RefClass::isKindOfMAParticleCurveSizeGenerate', {'refId': refId});
    return result;
  }
  ...
  Future<bool> isKindOfMAParticleEmissionModule() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod(
            'RefClass::isKindOfMAParticleEmissionModule', {'refId': refId});
    return result;
  }

  Future<bool> isKindOfMAParticleSinglePointShapeModule() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfMAParticleSinglePointShapeModule',
            {'refId': refId});
    return result;
  }
  ...
  Future<bool> isKindOfMAParticleRectShapeModule() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod(
            'RefClass::isKindOfMAParticleRectShapeModule', {'refId': refId});
    return result;
  }
  ...
  Future<bool> isKindOfMAParticleOverLifeModule() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod(
            'RefClass::isKindOfMAParticleOverLifeModule', {'refId': refId});
    return result;
  }
  ...
  Future<bool> isKindOfMAParticleOverlayOptions() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod(
            'RefClass::isKindOfMAParticleOverlayOptions', {'refId': refId});
    return result;
  }

  Future<bool> isKindOfMAParticleOverlayOptionsFactory() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfMAParticleOverlayOptionsFactory',
            {'refId': refId});
    return result;
  }
  ...
  Future<bool> isKindOfMAOverlayRenderer() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfMAOverlayRenderer', {'refId': refId});
    return result;
  }

  Future<bool> isKindOfMAUserLocation() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfMAUserLocation', {'refId': refId});
    return result;
  }

  Future<bool> isKindOfMAMultiPointItem() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfMAMultiPointItem', {'refId': refId});
    return result;
  }
  ...
  Future<bool> isKindOfMAMultiPointOverlay() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod(
            'RefClass::isKindOfMAMultiPointOverlay', {'refId': refId});
    return result;
  }

  Future<bool> isKindOfMACustomBuildingOverlayOption() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfMACustomBuildingOverlayOption',
            {'refId': refId});
    return result;
  }
  ...
  Future<bool> isKindOfMACustomBuildingOverlay() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod(
            'RefClass::isKindOfMACustomBuildingOverlay', {'refId': refId});
    return result;
  }

  Future<bool> isKindOfMATracePoint() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfMATracePoint', {'refId': refId});
    return result;
  }

  Future<bool> isKindOfMATraceLocation() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfMATraceLocation', {'refId': refId});
    return result;
  }

  Future<bool> isKindOfMAArc() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfMAArc', {'refId': refId});
    return result;
  }
  ...
  Future<bool> isKindOfMAUserLocationRepresentation() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod(
            'RefClass::isKindOfMAUserLocationRepresentation', {'refId': refId});
    return result;
  }

  Future<bool> isKindOfMAMapView() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfMAMapView', {'refId': refId});
    return result;
  }
  ...
  Future<bool> isKindOfMAOverlayPathRenderer() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod(
            'RefClass::isKindOfMAOverlayPathRenderer', {'refId': refId});
    return result;
  }
  ...
  Future<bool> isKindOfMAGroundOverlayRenderer() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod(
            'RefClass::isKindOfMAGroundOverlayRenderer', {'refId': refId});
    return result;
  }

  Future<bool> isKindOfMACustomBuildingOverlayRenderer() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::isKindOfMACustomBuildingOverlayRenderer',
            {'refId': refId});
    return result;
  }
  ...
  Future<MAParticleOverlayRenderer> asMAParticleOverlayRenderer() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod(
            'RefClass::asMAParticleOverlayRenderer', {'refId': refId});
    return MAParticleOverlayRenderer()..refId = result;
  }

  Future<MACoordinateBounds> asMACoordinateBounds() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::asMACoordinateBounds', {'refId': refId});
    return MACoordinateBounds()..refId = result;
  }

  Future<MACoordinateSpan> asMACoordinateSpan() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::asMACoordinateSpan', {'refId': refId});
    return MACoordinateSpan()..refId = result;
  }

  Future<MACoordinateRegion> asMACoordinateRegion() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::asMACoordinateRegion', {'refId': refId});
    return MACoordinateRegion()..refId = result;
  }

  Future<MAMapPoint> asMAMapPoint() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::asMAMapPoint', {'refId': refId});
    return MAMapPoint()..refId = result;
  }

  Future<MAMapSize> asMAMapSize() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::asMAMapSize', {'refId': refId});
    return MAMapSize()..refId = result;
  }

  Future<MAMapRect> asMAMapRect() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::asMAMapRect', {'refId': refId});
    return MAMapRect()..refId = result;
  }

  Future<MAParticleRandomVelocityGenerate>
      asMAParticleRandomVelocityGenerate() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod(
            'RefClass::asMAParticleRandomVelocityGenerate', {'refId': refId});
    return MAParticleRandomVelocityGenerate()..refId = result;
  }

  Future<MAParticleRandomColorGenerate>
      asMAParticleRandomColorGenerate() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod(
            'RefClass::asMAParticleRandomColorGenerate', {'refId': refId});
    return MAParticleRandomColorGenerate()..refId = result;
  }

  Future<MAParticleConstantRotationGenerate>
      asMAParticleConstantRotationGenerate() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod(
            'RefClass::asMAParticleConstantRotationGenerate', {'refId': refId});
  ...
  Future<MAParticleCurveSizeGenerate> asMAParticleCurveSizeGenerate() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod(
            'RefClass::asMAParticleCurveSizeGenerate', {'refId': refId});
    return MAParticleCurveSizeGenerate()..refId = result;
  }

  Future<MAParticleEmissionModule> asMAParticleEmissionModule() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::asMAParticleEmissionModule', {'refId': refId});
    return MAParticleEmissionModule()..refId = result;
  }

  Future<MAParticleSinglePointShapeModule>
      asMAParticleSinglePointShapeModule() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod(
            'RefClass::asMAParticleSinglePointShapeModule', {'refId': refId});
  ...
  Future<MAUserLocationRepresentation> asMAUserLocationRepresentation() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod(
            'RefClass::asMAUserLocationRepresentation', {'refId': refId});
    return MAUserLocationRepresentation()..refId = result;
  }

  Future<MAMapView> asMAMapView() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::asMAMapView', {'refId': refId});
    return MAMapView()..refId = result;
  }

  Future<MAOverlayPathRenderer> asMAOverlayPathRenderer() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::asMAOverlayPathRenderer', {'refId': refId});
    return MAOverlayPathRenderer()..refId = result;
  }

  Future<MAGroundOverlayRenderer> asMAGroundOverlayRenderer() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod('RefClass::asMAGroundOverlayRenderer', {'refId': refId});
    return MAGroundOverlayRenderer()..refId = result;
  }

  Future<MACustomBuildingOverlayRenderer>
      asMACustomBuildingOverlayRenderer() async {
    final result = await MethodChannel('me.yohom/amap_base_flutter')
        .invokeMethod(
            'RefClass::asMACustomBuildingOverlayRenderer', {'refId': refId});
