...
class MAParticleConstantRotationGenerate extends NSObject with MAParticleRotationGenerate {
  ...
  Future<MAParticleConstantRotationGenerate> initWithRotate(double rotate) async {
    ...
    if (result == null) {
      ...
      kNativeObjectPool.add(MAParticleConstantRotationGenerate()..refId = result..tag = 'amap_base_flutter');
      return MAParticleConstantRotationGenerate()..refId = result..tag = 'amap_base_flutter';
    }
  }
