...
class DownloadProgressViewFactory extends PlatformViewFactory {
    ...
    DownloadProgressViewFactory(Registrar registrar) {
        ...
        new MethodChannel(registrar.messenger(), "me.yohom/amap_base_flutter/com_amap_api_maps_offlinemap_DownloadProgressView").setMethodCallHandler((methodCall, methodResult) -> {
